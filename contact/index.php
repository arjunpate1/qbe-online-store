    ...
    <body>
        ...
        <div class="fsm-container" id="fsm-menu">
            <div class="fsm-padding">
                ...
                <ul class="fsm-nav">
                    ...
                    <li class="shrink"><a href="../apparel/index.html">Apparel</a></li>
                    <li class="shrink"><a href="../footwear/index.html">Footwear</a></li>
                    <li class="shrink"><a href="../accessories/index.html">Accessories</a></li>
                    <li class="shrink"><a href="../bags/index.html">Bags</a></li>
                    <li class="shrink"><a href="../contact/index.html" class="active-head">Contact</a></li>
                </ul>
            </div>
        </div>
        ...
        <header class="fixed">  
            ...
            <nav>
                <ul>
                    ...
                    <li class="padfix"><a href="../apparel/index.html">Apparel</a></li>
                    <li class="padfix"><a href="../footwear/index.html">Footwear</a></li>
                    <li class="padfix"><a href="../accessories/index.html">Accessories</a></li>
                    <li class="padfix"><a href="../bags/index.html">Bags</a></li>
                    <li class="padfix"><a href="#" class="active-head">Contact</a></li>
        ...
        <section class="hero-section-blank">
            <div class="container">
                ...
                <h2 class="sub-title-text white space-md">fill out the form below to send us a message</h2>
            ...
            <div class="col-3">
                <div class="contact-form">
                    ...
                    <form method="post" action="index.php">
                        ...
                        <label class="form-question">What is 3 + 3? (Anit-Spam)</label>
                        <input class="form-field" name="human" placeholder="Answer Here">
